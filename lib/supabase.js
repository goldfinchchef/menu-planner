...
// Note: we always create the client if credentials exist, but operations
// check isSupabaseMode() before actually using it
...
export function isConfigured() {
  // Must be in Supabase mode AND have credentials
  return isSupabaseMode() && !!supabase;
}
